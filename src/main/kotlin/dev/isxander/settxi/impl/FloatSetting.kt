...
class FloatSettingWrapped(annotation: FloatSetting, provider: IValueProvider<Float>) : Setting<Float, FloatSetting>(annotation, provider) {
    ...
    override val dataType: DataTypes = DataTypes.Float
